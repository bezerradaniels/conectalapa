...
import { Home, Search, Building2, Menu, X } from 'lucide-react';
...
export const BottomBar: React.FC<BottomBarProps> = ({ user, onLogout }) => {
    ...
    return (
        <>
            {/* Mobile Bottom Bar */}
            <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 z-40 safe-area-inset-bottom">
                    ...
                    <div className="md:hidden fixed top-0 left-0 right-0 bg-white z-50 shadow-xl animate-slide-in-top">
                        <div className="p-4 border-b border-neutral-200">
                            <div className="flex items-center gap-3 mb-4">
                                <h2 className="text-lg font-bold text-neutral-900 flex-1">Buscar</h2>
                                <button
                                    onClick={() => setIsSearchOpen(false)}
