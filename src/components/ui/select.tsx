    ...
    <div className="w-full space-y-1.5 text-left font-sans">
      ...
      <div className="relative">
        <select
          ...
          className={cn(
            'w-full h-10 pl-3 pr-10 py-2 text-base md:text-sm rounded-lg bg-bg-surface text-text-primary',
            'border border-border-hairline transition-colors appearance-none cursor-pointer',
