...
import { formatEventDateRange, getEventPriceDisplay, extractNeighborhood } from '@/lib/format'
...
export default function EventDetailPage() {
  ...
  // Past events stay live on WhatsApp long after the date, so they render
  // fully (not a 404) with a banner instead of disappearing.
